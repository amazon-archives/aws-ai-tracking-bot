...
/* eslint-disable space-before-function-paren, wrap-iife, func-names, max-len */
import botLoader from './bot-loader-vue';
...
export default {
  ...
  mounted() {
    var child = this.$refs.report;
    console.info('App Vue Mounted');
    botLoader(document, window, child);
  },
};
