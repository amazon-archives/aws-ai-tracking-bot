...
import com.mysampleapp.demo.YourHistory;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, YourHistory.OnFragmentInteractionListener {
    ...
    private String botName = "TrackingBot"; // to be replaced during setup
    ...
    private void setupNavigationMenu(final Bundle savedInstanceState) {
        ...
        navigationDrawer = new NavigationDrawer(this, toolbar, drawerLayout, drawerItems,
            R.id.main_fragment_container, botName);
